...
class StreamingExample:
    def __init__(self, drone):
        ...
        self.renderer = None
        self.video_filepath = os.path.join(self.tempd, "streaming.mp4")
        self.metadata_filepath = os.path.join(self.tempd, "streaming_metadata.json")
    ...
    def start(self):
        ...
        # post processing.
        # output stream at the end to mp4 
        

        self.drone.streaming.set_output_files(
            video=self.video_filepath,
            metadata=self.metadata_filepath,
        )

        # Setup your callback functions to do some live video processing
        # callback functions for live streamed data 
    ...
    def yuv_frame_cb(self, yuv_frame):
        ...
        print(f"Frame {type(yuv_frame)}, {yuv_frame}")
    ...
    def h264_frame_cb(self, h264_frame):
        ...
        This function will be called by Olympe for each new h264 frame.
            ...
            :type yuv_frame: olympe.VideoFrame
        """
        print(f"H264 Frame {type(h264_frame)}, {h264_frame}")
    ...
    def fly(self):
        ...
        for i in range(4):
            ...
            self.drone(moveBy(3, 0, 0, math.pi, _timeout=7)).wait().success()
